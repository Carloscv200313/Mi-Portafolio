...
export default function ContactoOscuroMejorado() {
  ...
  return (
    <div className="min-h-[90vh] flex items-center justify-center p-4 bg-fixed bg-no-repeat bg-center">
      <div className="relative z-10 w-full px-2 md:px-10 grid md:grid-cols-2 gap-10 h-full items-center justify-center text-white">
        {/* Imagen GIF */}
        ...
        {/* Formulario */}
        <Card className="bg-transparent backdrop-blur-sm w-full md:max-w-lg mx-auto">
          <CardHeader>
