...
const es: Dictionary = {
  ...
  hero: {
    ...
    description:
      "Diseño arquitectura de software y construyo sistemas SaaS escalables de punta a punta: modelado de dominio, multitenancy, autenticación y control de acceso, integraciones con IA. Next.js, TypeScript y Node.js como base, en remoto o híbrido desde Lima.",
  ...
  sobreMi: {
    ...
    stacks: [
      ...
      { title: "Backend & datos", items: ["Node.js, Express, NestJS, Django", "PostgreSQL, MySQL, SQL Server", "APIs REST y GraphQL, autenticación JWT, cifrado AES-256"] },
  ...
  casosEstudio: {
    ...
    cases: [
      ...
      },
      {
        ...
        stack: "Next.js 16, Node.js, Tailwind v4",
        role: "Full-stack",
...
const en: Dictionary = {
  ...
  hero: {
    ...
    description:
      "I design software architecture and build scalable SaaS systems end to end: domain modeling, multitenancy, authentication and access control, AI integrations. Next.js, TypeScript and Node.js as the base, remote or hybrid from Lima.",
    tags: ["Next.js", "TypeScript", "Node.js", "PostgreSQL", "Docker / AWS"],
  ...
  sobreMi: {
    ...
    stacks: [
      { title: "Frontend", items: ["TypeScript, JavaScript ES6+", "React, Next.js (App Router)", "Tailwind CSS, Framer Motion"] },
      { title: "Backend & data", items: ["Node.js, Express, NestJS, Django", "PostgreSQL, MySQL, SQL Server", "REST & GraphQL APIs, JWT auth, AES-256 encryption"] },
